                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-7 col-md-8">
                            <div class="hero__text">
                                ...
                                <a href="{{ asset('/shop') }}" class="primary-btn">Shop now <span class="arrow_right"></span></a>
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ URL::TO ( 'image/'.$pro->image ) }}">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="{{ asset('/scearch') }}"><img src="img/icon/search.png" alt=""></a></li>
                            </ul>
                        </div>
