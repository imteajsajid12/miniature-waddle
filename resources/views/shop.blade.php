                                        ...
                                        <div class="card-body">
                                            <div class="shop__sidebar__categories">
                                                <ul class="nice-scroll">
                                                    <li><a href="{{ asset('/shop/man') }}">Men</a></li>
                                                    <li><a href="{{ asset('/shop/women') }}">Women</a></li>
                                                    <li><a href="{{ asset('/shop/bag') }}">Bags </a></li>
                                                    <li><a href="{{ asset('/shop/clothing') }}">Clothing </a></li>
                                                    <li><a href="{{ asset('/shop/shoes') }}">Shoes </a></li>
                                                    <li><a href="{{ asset('/shop/accessories') }}">Accessories </a></li>
                                                    <li><a href="{{ asset('/shop/kids') }}">Kids </a></li>
